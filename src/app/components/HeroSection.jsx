        ...
        <div>
            <div className="flex items-center justify-center  py-20    bg-red-50  ">
                <div className="flex flex-col gap-6   items-center">
                    ...
                    <p className="text-center text-slate-600 ">A plataforma que conecta doadores de sangue com hemocentros de forma inteligente,
                        <br /> facilitando doações e salvando vidas através da tecnologia.</p>
